...
class Renderer(xml.XmlRenderer):
    ...
    stylesheet = TagProp('stylesheet', {'version', 'id', 'extension-element-prefixes', 'exclude-result-prefixes'})
    template = TagProp('template', {'match', 'name', 'priority', 'mode'})
    text = TagProp('text')
    transform = TagProp('transform', {'version', 'id', 'extension-element-prefixes', 'exclude-result-prefixes'})
